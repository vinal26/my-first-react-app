            ...
            <div className="row px-2 mt-3">
                <div className="col-md-8">
                    ...
                    {isLoading ? (
                        ...
                        : filterdata?.length == 0 ? (
                            <Loader textClassName={`mt-0 text-center`} showBR={false} emptyTextKey={`noData`} mainClassName={`active_n0data2`} />
                        )
                            : (
                                        ...
                                        <React.Fragment key={index}>
                                            <div className="ques mt-3 p-4 shadow-sm">
                                                ...
                                                <div className=" d-flex justify-content-between mb-3">
                                                    ...
                                                    <div className="d-flex align-items-center"><h5 className="mb-0">{curElem.post}</h5><span className="ms-2 text-secondary"> • {isYesterday(parseISO(curElem.createdAt)) ? "Posted Yesterday" : isToday(parseISO(curElem.createdAt)) ? "Posted " + calT(curElem.createdAt) + " ago" : format(parseISO(curElem.createdAt), 'do MMM, yyyy')}</span></div>
                                                    {curElem.createdBy._id === auth?.authUser?._id ?
                                                        <div>
                                                            ...
                                                            >
                                                                <FaEdit className="like_group " data-bs-toggle="modal" data-bs-target="#forumModal"></FaEdit>
                                                            </span>
                                                            <span
                                                                onClick={() => setPostId(curElem._id)}
                                                            > <FaTrash data-bs-toggle="modal"
                                                                data-bs-target="#deletePost" className="like_group me-0" /></span>
                                                        </div> : null}
                                                </div>
                            ...
                            <form onSubmit={handleAskQuestion}>
                                <div className="col-md-12">
                                    ...
                                    <div className="d-flex justify-content-between mt-1">
                                        <button className='description_btnsave-white mx-0' data-bs-dismiss="modal">Cancel</button>
...
export default ActiveForumsView;
