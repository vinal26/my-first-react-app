...
const ActiveMemberModal = ({ addMember, members, open, setOpen, setMembers }) => {
    ...
    const UpdateMember = (checked, members) => {
        console.log("Inside");
        ...
        if (checked) {
            ...
            setCheck(prev => prev-1);
            setMembers((prev) => prev.filter(dt => dt._id != member._id))
        }
    }
            ...
            <div className="modal-dialog">
                <div className="modal-content px-4">
                    <div className="modal-header px-4 border-0 mt-3">
                        ...
                        <button type="button" className="btn-close" onClick={() => setOpen(false)} data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                                                    ...
                                                    <div className="btn-group align-items-center gap-2">
                                                        <p className="affir_checkbox mb-0">
                                                            <input
                                                                type="checkbox"
                                                                name="members"
                                                                value={JSON.stringify({_id: dt._id, name: dt.full_name, email: dt.email})}
                                                                id="flexCheckDefault"
                    ...
                    <div className="modal-footer px-3 border-0 mb-3">
                        <button onClick={() => {addMember(); setOpen(false)}} data-bs-dismiss="modal"
                            disabled={check==0}
