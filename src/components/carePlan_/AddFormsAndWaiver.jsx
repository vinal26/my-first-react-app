...
import { createCarePlanFormService, getSingleCarePlanFormListService } from "../../services/CreateCarePlanService";
...
const AddFormsAndWaiver = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isValid) {
            ...
            showToastError("Please fill all the fields before submitting")
        }
    ...
    const renderForm = () => {
        return (
            <>
                <div className="my-4">
                    {/* <h1 style={{ color: "#1f7e78" }}>Add forms and Waivers</h1> */}
                    <h3 className="mt-4">Create a Form or Waiver</h3>
                    <p className="text-secondary">Customize your form and share it with your clients to complete!</p>
                </div>
                                                            ...
                                                            <div className="row mt-3">
                                                                <div className="col-md-12">
                                                                    <div className=" col-md-3 card px-2 mt-1 mb-2">
                                                                        <p className="whole_label mt-1">Client Waiver</p>
                                                                    </div>
                                                    ...
                                                    <div className="col-md-11">
                                                        <div className="card px-4 mb-2">
                                                            <div className="row mt-3">
                                                                <div className="col-md-12">
                                                                    <div className=" col-md-3 card px-2 mt-1 mb-2">
                                                                        <p className="whole_label mt-1">My Waiver</p>
                                                                    </div>
                    ...
                    <div className="col-md-10 py-4 px-5">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active fw-bold" aria-current="page">Add Forms & Waivers</li>
                            </ol>
                        </nav>
                        {renderForm()}
                    </div>
...
export default AddFormsAndWaiver;
