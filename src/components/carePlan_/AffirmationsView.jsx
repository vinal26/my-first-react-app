...
const AffirmationsView = () => {
    ...
    const renderLoader = () => {
        return (
            <Loader
                visible={isLoading}
                emptyTextKey={'pleaseAddAffirmations'}
    ...
    const renderList = () => {
        return (
            <tbody>
                ...
                {carePlan?.affirmations?.length ? carePlan?.affirmations?.map((dt) => {
                    return (
                        <tr>
                            <td className="text-muted">{dt}</td>
                        </tr>
                    )
                }) : renderLoader()}
            </tbody>
            ...
            <>
                ...
                <div className="col-md-12 mt-4">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <td className="py-4" scope="col text-secondary">Affirmations Name</td>
                    ...
                    <div className="col-md-10 py-4 px-5">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active fw-bold" aria-current="page">Affirmations</li>
                            </ol>
                        </nav>
                        ...
                        <div className="col-md-12 mt-5">
                            ...
                            <div className="d-flex justify-content-between">
                                ...
                                <button isLoading={isLoading} type="submit" id="reateProgram" text={'Save & Continue'} style={isLoading ? { cursor: 'none' } : {}} className="description_btnsave" onClick={() => { navigate("/editplan", { state: { careplan: carePlan } }) }}>Add Affirmations</button>
                            </div>
                        </div>
                    </div>
                </div>
