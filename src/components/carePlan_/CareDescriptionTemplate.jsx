...
const CareDescriptionTemplate = (props) => {
    let location = useLocation();
    let plan = location?.state.careplan || [];
    const newcareplanId = props.newcareplanId ? props.newcareplanId : plan._id;
    const getDate = (date) => {
        try {
    ...
    const [careSupplimentsEdit, setCareSupplimentsEdit] = useState([]);
                ...
                <div className="row mt-5 mx-5">
                    ...
                    <div className="col-md-12 mt-5">
                        ...
                        <div className="d-flex justify-content-between">
                            <div text={'Cancel'} style={isLoading ? { cursor: 'none' } : { cursor: 'pointer', backgroundColor: '#fff', color: 'black', border: '1px solid #bbb9b9' }} className="description_btnsave d-flex justify-content-center align-items-center" onClick={() => !isLoading && navigate('/careplan')}>Cancel</div>
                            <Button isLoading={isLoading} type="submit" id="reateProgram" text={'Save & Continue'} style={isLoading ? { cursor: 'none' } : {}} className="description_btnsave" />
                        </div>
                    </div>
...
export default CareDescriptionTemplate;